...
[_QWERTY] = LAYOUT_preonic_2x2u(
  ...
  KC_LALT, KC_LGUI, LOWER,   KC_LSFT, KC_SPC,           KC_ENT,           KC_RCTL, RAISE,   KC_LBRC, KC_RBRC
),
...
[_LOWER] = LAYOUT_preonic_2x2u(
  KC__MUTE, KC_F2  , KC_F3  , KC_F4  , KC_F5  , KC_F6  , KC_F7  , KC_F8  ,   KC_F9  ,    KC_F10 , KC_F11    , KC_F12,
  ...
  RGB_MOD, _______, _______, _______, KC_SPC,           KC_ENT,             _______,    ADJUST,  _______   , _______
),
...
[_RAISE] = LAYOUT_preonic_2x2u(
  ...
  RGB_TOG, _______, ADJUST,  _______, KC_SPC,           KC_ENT,             _______,   _______, _______,  _______
), 
...
[_ADJUST] = LAYOUT_preonic_2x2u(
  ...
  _______, _______, _______, _______, KC_SPC,           KC_ENT,           KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
)
