...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,     KC_C,       KC_V,      KC_B, KC_MUTE,    XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_EQL,
...
[_COLEMAK] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V, KC_MUTE,      RGB_TOG,KC_K,    KC_H, KC_COMM,  KC_DOT, KC_SLSH,  KC_EQL,
                 KC_LALT,  KC_LGUI,   KC_LOWER,   KC_LSFT, KC_SPC,           KC_ENT, KC_RCTRL, KC_RAISE, KC_LBRC, KC_RBRC
),
