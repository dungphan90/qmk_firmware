...
[_QWERTY] = LAYOUT(
  ...
  ALT_T(KC_TAB),   KC_Q,   KC_W,     KC_E,       KC_R,      KC_T,                     KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,  KC_QUOT,
  GUI_T(KC_ESC),   KC_A,   KC_S,     KC_D,       KC_F,      KC_G,                     KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN,  KC_BSPC,
  KC_BSLS,  KC_Z,   KC_X,     KC_C,       KC_V,      KC_B,  _______,   _______,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_EQL,
...
[_LOWER] = LAYOUT(
  ...
  _______,  _______, _______, _______, _______, _______, KC_MUTE,       _______, KC_HOME, KC_PGDOWN, KC_PGUP, KC_END, _______, _______,
                       _______, _______, _______, _______, _______,       _______, _______, KC_ADJUST, _______, _______
),
 ...
 */
  ...
  RESET  , XXXXXXX,KC_QWERTY,KC_COLEMAK, XXXXXXX,XXXXXXX,                     XXXXXXX, XXXXXXX, RGB_VAI, RGB_VAD, XXXXXXX, XXXXXXX, \
  KC_CAPS , XXXXXXX,CG_TOGG, XXXXXXX,    XXXXXXX,  XXXXXXX,                     XXXXXXX, XXXXXXX, RGB_SAI, RGB_SAD, XXXXXXX, XXXXXXX, \
  XXXXXXX , XXXXXXX, XXXXXXX, XXXXXXX,    XXXXXXX,  XXXXXXX, XXXXXXX,     XXXXXXX, XXXXXXX, RGB_TOG, RGB_HUI, RGB_HUD, XXXXXXX, XXXXXXX, \
                   _______, _______, _______, _______, _______,     _______, _______, _______, RGB_RMOD, RGB_MOD \
  )
};
